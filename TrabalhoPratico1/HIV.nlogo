globals [
  virus-chance       ;; A chance out of 100 that an infected person will pass on
...
to setup-globals
  set virus-chance 50    ;; if you have unprotected contact with an infected person,
...
to infect  ;; turtle procedure
  if coupled? and infected? and not known?
    [ if random-float 10 > condom-use or
        ...
        [ if random-float 100 < virus-chance
